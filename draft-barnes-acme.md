...
: The length, in bits, of the derived secret.  The value MUST be a multiple of 8.

confirm (optional, string):
: The confirmation value, base64-encoded

In the client's request, this object contains a JWK for a random ECDH public key generated by the client.
